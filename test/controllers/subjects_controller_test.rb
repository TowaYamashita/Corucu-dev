...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { course: @subject.course, instructor: @subject.instructor } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { course: @subject.course, instructor: @subject.instructor } }
